...
import { HttpClientService } from '../ch27-http-api/http-client.service';
...
@Component({
  selector: 'app-ch27-weather-practice',
  templateUrl: './ch27-weather-practice.html',
  styleUrl: './ch27-weather-practice.css',
  standalone: true,
  imports: []
})
export class Ch27WeatherPractice implements OnInit {
